<?php defined('IN_ZLCMS') or exit('No permission resources.'); ?><div class="footer">
<p class="info">
...
<br />
Powered by <strong><a href="http://www.ZLCMS.cn" target="_blank">ZLCMS</a></strong> <em><?php echo get_pc_version(1);?></em> &copy; 2011 <img src="<?php echo IMG_PATH;?>copyright.gif"/><?php echo tjcode();?><?php echo runhook('glogal_footer')?>
</p>
</div>
