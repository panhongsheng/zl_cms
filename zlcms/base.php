...
define('IN_ZLCMS', true);
//ZLCMS框架路径
define('PC_PATH', dirname(__FILE__).DIRECTORY_SEPARATOR);
if(!defined('ZLCMS_PATH')) define('ZLCMS_PATH', PC_PATH.'..'.DIRECTORY_SEPARATOR);
//缓存文件夹地址
define('CACHE_PATH', ZLCMS_PATH.'caches'.DIRECTORY_SEPARATOR);
//主机协议
