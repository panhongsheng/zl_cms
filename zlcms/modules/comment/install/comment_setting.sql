DROP TABLE IF EXISTS `ZLCMS_comment_setting`;
CREATE TABLE IF NOT EXISTS `ZLCMS_comment_setting` (
...
INSERT INTO `ZLCMS_comment_setting` (`siteid`, `guest`, `check`, `code`, `add_point`, `del_point`) VALUES (1, 0, 0, 0, 0, 0);
