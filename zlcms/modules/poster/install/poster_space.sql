DROP TABLE IF EXISTS `ZLCMS_poster_space`;
CREATE TABLE IF NOT EXISTS `ZLCMS_poster_space` (
...
INSERT INTO `ZLCMS_poster_space` (`siteid`, `spaceid`, `name`, `type`, `path`, `width`, `height`, `setting`, `description`, `items`, `disabled`) VALUES
