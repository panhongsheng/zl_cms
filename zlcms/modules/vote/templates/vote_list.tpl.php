...
function call(id) {
	...
	window.top.art.dialog({title:'<?php echo L('vote')?><?php echo L('linkage_calling_code','','zl_admin');?>', id:'call', iframe:'?m=vote&c=vote&a=public_call&subjectid='+id, width:'600px', height:'470px'}, function(){window.top.art.dialog({id:'call'}).close();}, function(){window.top.art.dialog({id:'call'}).close();})
}
