...
<form action="?m=zl_admin&c=badword&a=add" method="post" name="myform" id="myform">
 	<tr> 
...
<input type="hidden" name="forward" value="?m=zl_admin&c=badword&a=add">
