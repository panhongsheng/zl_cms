...
<form name="myform" action="?m=zl_admin&c=category&a=batch_edit" method="post">
<div class="pad_10">
...
function load_file_list(id,catid) {
	if(id=='') return false;
	$.getJSON('?m=zl_admin&c=category&a=public_tpl_file_list&batch_str=1&type=1&style='+id+'&catid='+catid, function(data){
