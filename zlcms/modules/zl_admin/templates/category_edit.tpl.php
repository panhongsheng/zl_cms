...
<form name="myform" id="myform" action="?m=zl_admin&c=category&a=edit" method="post">
<div class="pad-10">
<div class="col-tab">
...
<!--
	...
	function load_file_list(id) {
		if(id=='') return false;
		$.getJSON('?m=zl_admin&c=category&a=public_tpl_file_list&style='+id+'&catid=<?php echo $catid?>', function(data){$('#category_template').html(data.category_template);$('#list_template').html(data.list_template);$('#show_template').html(data.show_template);});
	}
