...
<div class="pad-lr-10">
<form name="downform" action="?m=zl_admin&c=downservers&a=init" method="post" >
...
<form name="myform" action="?m=zl_admin&c=downservers&a=listorder" method="post">
...
?>   
	...
	<a href="javascript:confirmurl('?m=zl_admin&c=downservers&a=delete&id=<?php echo $info['id']?>', '<?php echo L('downserver_del_cofirm')?>')"><?php echo L('delete')?></a>
	</td>
	</tr>
<?php 
	}
...
<!--
	...
	window.top.art.dialog({title:'<?php echo L('edit')?>--'+name, id:'edit', iframe:'?m=zl_admin&c=downservers&a=edit&id='+id ,width:'520px',height:'150px'}, 	function(){var d = window.top.art.dialog({id:'edit'}).data.iframe;
