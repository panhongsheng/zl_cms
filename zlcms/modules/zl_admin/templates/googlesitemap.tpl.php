...
<form method="post" name="myform" id="myform" action="?m=zl_admin&c=googlesitemap&a=set">
<input type="hidden" name="tabletype" value="ZLCMStables" id="ZLCMStables">
...
<?php echo $string;?>
  	...
  	<tr>
	    ...
	    <td colspan=3><input type=text name="email" value="ZLCMS@ZLCMS.cn" size=20></td>
  	</tr>
  	<tr>
