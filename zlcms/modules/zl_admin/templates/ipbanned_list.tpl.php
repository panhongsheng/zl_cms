...
?>
<div class="pad-lr-10">
<form name="searchform" id="searchform" action="?m=zl_admin&c=ipbanned&a=search_ip&menuid=<?php echo $_GET['menuid'];?>" method="get"  >
...
<form name="myform" id="myform" action="?m=zl_admin&c=ipbanned&a=delete" method="post" onsubmit="checkuid();return false;">
...
?>
	...
	<input type="checkbox" name="ipbannedid[]" value="<?php echo $info['ipbannedid']?>">
        ...
        <td align="center"><?php echo date('Y-m-d', $info['expires']);?></td>
         <td align="center"><a href="javascript:confirmurl('?m=zl_admin&c=ipbanned&a=delete&ipbannedid=<?php echo $info['ipbannedid']?>', '<?php echo L('confirm', array('message' => L('selected')))?>')"><?php echo L('delete')?></a> </td>
    </tr>
<?php
	}
}
