...
?>
<div class="pad-lr-10">
<form name="myform" id="myform" action="?m=zl_admin&c=keylink&a=delete" method="post" onsubmit="checkuid();return false;">
...
?>
	...
	<input type="checkbox" name="keylinkid[]" value="<?php echo $info['keylinkid']?>">
        ...
        <td align="center"><?php echo $info['url']?></td>
         <td align="center"><a href="javascript:edit(<?php echo $info['keylinkid']?>, '<?php echo new_addslashes($info['word'])?>')"><?php echo L('edit')?></a> | <a href="javascript:confirmurl('?m=zl_admin&c=keylink&a=delete&keylinkid=<?php echo $info['keylinkid']?>', '<?php echo L('keylink_confirm_del')?>')"><?php echo L('delete')?></a> </td>
    </tr>
<?php
	}
}
