...
?>
<div class="pad-lr-10"> 
<form name="searchform" action="?m=zl_admin&c=log&a=search_log&menuid=<?php echo $_GET['menuid'];?>" method="get" >
...
<form name="myform" id="myform" action="?m=zl_admin&c=log&a=delete" method="post" onsubmit="checkuid();return false;">
