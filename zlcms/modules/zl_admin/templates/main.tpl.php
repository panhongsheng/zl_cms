...
include PC_PATH.'modules'.DIRECTORY_SEPARATOR.'zl_admin'.DIRECTORY_SEPARATOR.'templates'.DIRECTORY_SEPARATOR.'header.tpl.php';
?>
...
<div class="pad-10">
<form action="?m=zl_admin&c=cache_all&a=init&pc_hash=<?php echo $_SESSION['pc_hash'];?>" target="cache_if" method="post" id="myform" name="myform">
...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?>ZLCMS <?php echo PC_VERSION?>  Release <?php echo PC_RELEASE?> [<a href="http://download.ZLCMS.cn/v9/" target="_blank"><?php echo L('main_latest_version')?></a>]<br />
...
<div class="col-2 lf mr10" style="width:48%">
	...
	<?php echo L('main_product_site')?><a href="http://www.ZLCMS.cn/" target="_blank">http://www.ZLCMS.cn/</a> <br />
	<?php echo L('main_product_bbs')?><a href="http://bbs.ZLCMS.cn/" target="_blank">http://bbs.ZLCMS.cn/</a>
	</div>
</div>
...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?>ZLCMS <?php echo PC_VERSION?>  Release <?php echo PC_RELEASE?> [<a href="http://buy.ZLCMS.cn" target="_blank"><?php echo L('main_support')?></a>]<br />
	<?php echo L('main_license_type')?><span id="ZLCMS_license"></span> <br />
	<?php echo L('main_serial_number')?><span id="ZLCMS_sn"></span> <br />
	</div>
</div>
    <div class="bk10"></div>
</div>
