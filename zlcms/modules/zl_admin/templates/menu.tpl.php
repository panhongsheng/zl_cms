...
<?php if(ROUTE_A=='init') {?>
<form name="myform" action="?m=zl_admin&c=menu&a=listorder" method="post">
<div class="pad-lr-10">
...
<form name="myform" id="myform" action="?m=zl_admin&c=menu&a=add" method="post">
...
<div class="common-form">
<form name="myform" id="myform" action="?m=zl_admin&c=menu&a=edit" method="post">
<table width="100%" class="table_form contentWrap">
      <tr>
        <th width="200"><?php echo L('menu_parentid')?>：</th>
