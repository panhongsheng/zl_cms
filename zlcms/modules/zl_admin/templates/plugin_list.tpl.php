...
?>
<form name="myform" action="?m=zl_admin&c=plugin&a=listorder" method="post">
<div class="pad_10">
...
?>   
	...
	<a href="?m=zl_admin&c=plugin&a=config&pluginid=<?php echo $info['pluginid']?>&menuid=<?php echo $_GET['menuid']?>">
	...
	<a href="?m=zl_admin&c=plugin&a=config&pluginid=<?php echo $info['pluginid']?>&menuid=<?php echo $_GET['menuid']?>"><?php echo L('plugin_config')?></a>
	<a href="?m=zl_admin&c=plugin&a=status&pluginid=<?php echo $info['pluginid']?>&disable=<?php echo intval($info['disable']) ? 0 : 1?>"><?php echo intval($info['disable']) ? L('plugin_close') : L('plugin_open')?></a> <a href="?m=zl_admin&c=plugin&a=delete&pluginid=<?php echo $info['pluginid']?>&menuid=<?php echo $_GET['menuid']?>"><?php echo L('plugin_uninstall')?></a>
	</td>
	</tr>
<?php 
	}
