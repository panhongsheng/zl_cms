...
<form name="myform" action="?m=zl_admin&c=position&a=add" method="post" id="myform">
...
function category_load(obj)
{
	...
	$.get('?m=zl_admin&c=position&a=public_category_load&modelid='+modelid,function(data){
